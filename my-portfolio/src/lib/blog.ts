...
const rawPosts = import.meta.glob('/src/content/blog/*.md', { as: 'raw', eager: true }) as Record<
  string,
  string
>;
...
export const getPostBySlug = (slug: string): BlogPost | null => {
  const entry = Object.entries(rawPosts).find(([path]) => getSlugFromPath(path) === slug);

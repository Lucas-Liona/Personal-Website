    ...
    <div className="pt-20">
      <section className="bg-slate-50 dark:bg-dark-100 py-20">
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-dark dark:text-light">Maps of Content</h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          {mocs.length === 0 ? (
            <div className="max-w-3xl mx-auto text-center text-slate-600 dark:text-slate-300">No MOCs yet.</div>
          ) : (
              ...
              {mocs.map((moc, index) => (
                ...
                >
                  <Link to={`/moc/${moc.slug}`} className="block">
                    ...
                    {moc.date && <p className="text-slate-500 dark:text-slate-400 mt-1">{moc.date}</p>}
